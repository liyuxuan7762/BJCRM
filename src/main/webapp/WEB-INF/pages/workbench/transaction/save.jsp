    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#create-transactionStage").change(function () {
                // 获取阶段名称
                var stageName = $("#create-transactionStage option:selected").text();
                if (stageName == "") {
            ...
            $("#saveTranBtn").click(function () {
                ...
                var customerName = $("#create-contactsName").val();
                var stage = $("#create-transactionStage").val();
                var type = $("#create-transactionType").val();
                var source = $("#create-clueSource").val();
                var activityId = $("#create-tran-ActivityId").val();
                var contactsId = $("#create-tran-ContactId").val();
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="hidden" id="create-tran-ActivityId" value="17bae7ff857e4f07a4d5e967c152182a">
    ...
    <div class="form-group">
        <label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a
                ...
                class="glyphicon glyphicon-search"></span></a></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="hidden" id="create-tran-ContactId" value="7da9852236684bd592f52b07a2ee9817">
            <input type="text" class="form-control" id="create-contactsName" value="李宇轩">
        </div>
    </div>
