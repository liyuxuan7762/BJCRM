...
public class Tran {
    ...
    public Tran(String id, String owner, String money, String name, String expectedDate, String customerId, String stage, String type, String source, String activityId, String contactsId, String createBy, String createTime, String description, String contactSummary, String nextContactTime) {
        this.id = id;
        this.owner = owner;
        this.money = money;
        this.name = name;
